module.exports = {
    ...
    deploy: {
      ...
      dev: {
        ...
        // post-deploy action
        "post-deploy": "echo pwd && touch .envrc && > .envrc && echo DB_DSN=$DEV_DB_DSN >> .envrc && echo HTTP_PORT=$DEV_HTTP_PORT >> .envrc && echo BASIC_AUTH_HASHED_PASSWORD=$BASIC_AUTH_HASHED_PASSWORD >> .envrc  && echo NOTIFICATIONS_EMAIL=$NOTIFICATIONS_EMAIL >> .envrc && make build && pm2 reload ecosystem.config.js --env dev && pm2 save",
        "env": {
